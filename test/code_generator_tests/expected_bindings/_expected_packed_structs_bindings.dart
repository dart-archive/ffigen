...
class NoPacking extends Opaque {
  NoPacking(int address) : super(address);
}

// @Packed(1)
class Pack1 extends Opaque {
  Pack1(int address) : super(address);
}

// @Packed(2)
class Pack2 extends Opaque {
  Pack2(int address) : super(address);
}

// @Packed(4)
class Pack21 extends Opaque {
  Pack21(int address) : super(address);
}

// @Packed(8)
class Pack22 extends Opaque {
  Pack22(int address) : super(address);
}

// @Packed(16)
class Pack16 extends Opaque {
  Pack16(int address) : super(address);
}
