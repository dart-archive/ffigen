...
/// Just a test struct
/// heres another line
class NoMember extends Opaque {
  NoMember(int address) : super(address);
}

class WithPrimitiveMember extends Opaque {
  WithPrimitiveMember(int address) : super(address);
}

class WithPointerMember extends Opaque {
  WithPointerMember(int address) : super(address);
}
