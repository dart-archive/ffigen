...
class Bindings {
  ...
  late final int Function() _noParam = lookup('noParam');
  ...
  late final int Function(
    int,
    int,
  ) _withPrimitiveParam = lookup('withPrimitiveParam');

  // --- withPointerParam ---
  Pointer<Double> withPointerParam(
    Pointer<Int32> a,
    Pointer<Pointer<Uint8>> b,
  ) {
  ...
  late final int Function(
    int,
    int,
  ) _withPointerParam = lookup('withPointerParam');
  @override
  String toString() {
