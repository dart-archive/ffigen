...
class NSObject extends _ObjCWrapper {
  ...
  static bool isSubclassOfClass_(
      CategoryTestObjCLibrary _lib, NSObject aClass) {
  ...
  static void setVersion_(CategoryTestObjCLibrary _lib, int aVersion) {
  ...
  static void poseAsClass_(CategoryTestObjCLibrary _lib, NSObject aClass) {
    _lib._objc_msgSend_8(
...
class NSString extends _ObjCWrapper {
  ...
  static NSString stringWithCString_encoding_(CategoryTestObjCLibrary _lib,
