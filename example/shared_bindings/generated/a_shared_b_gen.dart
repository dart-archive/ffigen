...
import '../generated/base_gen.dart' as base_h;
...
class NativeLibraryASharedB {
  ...
  void a_func2(
    base_h.BaseStruct2 s,
    base_h.BaseUnion2 u,
    base_h.BaseTypedef2 t,
  ) {
    return _a_func2(
      s,
      u,
  ...
  late final _a_func2Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(base_h.BaseStruct2, base_h.BaseUnion2,
              base_h.BaseTypedef2)>>('a_func2');
  late final _a_func2 = _a_func2Ptr.asFunction<
      void Function(
          base_h.BaseStruct2, base_h.BaseUnion2, base_h.BaseTypedef2)>();
}
