...
class Bindings {
  ...
  // --- WithTypealiasStruc1 ---
  Pointer<NativeFunction<Void Function()>> WithTypealiasStruc1(
    Struct3Typealias t,
  ) {
    return Pointer.fromAddress(
      NativeFunction<Void Function()>(
        _WithTypealiasStruc1(
          t,
        ),
      ),
    );
  ...
  late final int Function(
    Struct3,
  ) _WithTypealiasStruc1 = lookup('WithTypealiasStruc1');
  @override
  String toString() {
...
class WithTypealiasStruc extends Opaque {
  WithTypealiasStruc(int address) : super(address);
}

typedef Struct2Typealias = Struct2;

class Struct2 extends Opaque {
  Struct2(int address) : super(address);
}

typedef Struct3Typealias = Struct3;

class Struct3 extends Opaque {
  Struct3(int address) : super(address);
}
