...
class CXGlobalOptFlags {
  static const int ArrayHelperCXGlobalOpt_None = 0;
  static const int ArrayHelperCXGlobalOpt_ThreadBackgroundPriorityForIndexing =
      1;
  static const int ArrayHelperCXGlobalOpt_ThreadBackgroundPriorityForEditing =
      2;
  static const int ArrayHelperCXGlobalOpt_ThreadBackgroundPriorityForAll = 3;
}
...
class CXTypeKind {
  static const int ArrayHelperCXType_Invalid = 0;
  static const int ArrayHelperCXType_Unexposed = 1;
  static const int ArrayHelperCXType_Void = 2;
  static const int ArrayHelperCXType_Bool = 3;
  static const int ArrayHelperCXType_Char_U = 4;
  static const int ArrayHelperCXType_UChar = 5;
  static const int ArrayHelperCXType_Char16 = 6;
  static const int ArrayHelperCXType_Char32 = 7;
  static const int ArrayHelperCXType_UShort = 8;
  static const int ArrayHelperCXType_UInt = 9;
  static const int ArrayHelperCXType_ULong = 10;
  static const int ArrayHelperCXType_ULongLong = 11;
  static const int ArrayHelperCXType_UInt128 = 12;
  static const int ArrayHelperCXType_Char_S = 13;
  static const int ArrayHelperCXType_SChar = 14;
  static const int ArrayHelperCXType_WChar = 15;
  static const int ArrayHelperCXType_Short = 16;
  static const int ArrayHelperCXType_Int = 17;
  static const int ArrayHelperCXType_Long = 18;
  static const int ArrayHelperCXType_LongLong = 19;
  static const int ArrayHelperCXType_Int128 = 20;
  static const int ArrayHelperCXType_Float = 21;
  static const int ArrayHelperCXType_Double = 22;
  static const int ArrayHelperCXType_LongDouble = 23;
  static const int ArrayHelperCXType_NullPtr = 24;
  static const int ArrayHelperCXType_Overload = 25;
  static const int ArrayHelperCXType_Dependent = 26;
  static const int ArrayHelperCXType_ObjCId = 27;
  static const int ArrayHelperCXType_ObjCClass = 28;
  static const int ArrayHelperCXType_ObjCSel = 29;
  static const int ArrayHelperCXType_Float128 = 30;
  static const int ArrayHelperCXType_Half = 31;
  static const int ArrayHelperCXType_Float16 = 32;
  static const int ArrayHelperCXType_ShortAccum = 33;
  static const int ArrayHelperCXType_Accum = 34;
  static const int ArrayHelperCXType_LongAccum = 35;
  static const int ArrayHelperCXType_UShortAccum = 36;
  static const int ArrayHelperCXType_UAccum = 37;
  static const int ArrayHelperCXType_ULongAccum = 38;
  static const int ArrayHelperCXType_FirstBuiltin = 2;
  static const int ArrayHelperCXType_LastBuiltin = 38;
  static const int ArrayHelperCXType_Complex = 100;
  static const int ArrayHelperCXType_Pointer = 101;
  static const int ArrayHelperCXType_BlockPointer = 102;
  static const int ArrayHelperCXType_LValueReference = 103;
  static const int ArrayHelperCXType_RValueReference = 104;
  static const int ArrayHelperCXType_Record = 105;
  static const int ArrayHelperCXType_Enum = 106;
  static const int ArrayHelperCXType_Typedef = 107;
  static const int ArrayHelperCXType_ObjCInterface = 108;
  static const int ArrayHelperCXType_ObjCObjectPointer = 109;
  static const int ArrayHelperCXType_FunctionNoProto = 110;
  static const int ArrayHelperCXType_FunctionProto = 111;
  static const int ArrayHelperCXType_ConstantArray = 112;
  static const int ArrayHelperCXType_Vector = 113;
  static const int ArrayHelperCXType_IncompleteArray = 114;
  static const int ArrayHelperCXType_VariableArray = 115;
  static const int ArrayHelperCXType_DependentSizedArray = 116;
  static const int ArrayHelperCXType_MemberPointer = 117;
  static const int ArrayHelperCXType_Auto = 118;
  static const int ArrayHelperCXType_Elaborated = 119;
  static const int ArrayHelperCXType_Pipe = 120;
  static const int ArrayHelperCXType_OCLImage1dRO = 121;
  static const int ArrayHelperCXType_OCLImage1dArrayRO = 122;
  static const int ArrayHelperCXType_OCLImage1dBufferRO = 123;
  static const int ArrayHelperCXType_OCLImage2dRO = 124;
  static const int ArrayHelperCXType_OCLImage2dArrayRO = 125;
  static const int ArrayHelperCXType_OCLImage2dDepthRO = 126;
  static const int ArrayHelperCXType_OCLImage2dArrayDepthRO = 127;
  static const int ArrayHelperCXType_OCLImage2dMSAARO = 128;
  static const int ArrayHelperCXType_OCLImage2dArrayMSAARO = 129;
  static const int ArrayHelperCXType_OCLImage2dMSAADepthRO = 130;
  static const int ArrayHelperCXType_OCLImage2dArrayMSAADepthRO = 131;
  static const int ArrayHelperCXType_OCLImage3dRO = 132;
  static const int ArrayHelperCXType_OCLImage1dWO = 133;
  static const int ArrayHelperCXType_OCLImage1dArrayWO = 134;
  static const int ArrayHelperCXType_OCLImage1dBufferWO = 135;
  static const int ArrayHelperCXType_OCLImage2dWO = 136;
  static const int ArrayHelperCXType_OCLImage2dArrayWO = 137;
  static const int ArrayHelperCXType_OCLImage2dDepthWO = 138;
  static const int ArrayHelperCXType_OCLImage2dArrayDepthWO = 139;
  static const int ArrayHelperCXType_OCLImage2dMSAAWO = 140;
  static const int ArrayHelperCXType_OCLImage2dArrayMSAAWO = 141;
  static const int ArrayHelperCXType_OCLImage2dMSAADepthWO = 142;
  static const int ArrayHelperCXType_OCLImage2dArrayMSAADepthWO = 143;
  static const int ArrayHelperCXType_OCLImage3dWO = 144;
  static const int ArrayHelperCXType_OCLImage1dRW = 145;
  static const int ArrayHelperCXType_OCLImage1dArrayRW = 146;
  static const int ArrayHelperCXType_OCLImage1dBufferRW = 147;
  static const int ArrayHelperCXType_OCLImage2dRW = 148;
  static const int ArrayHelperCXType_OCLImage2dArrayRW = 149;
  static const int ArrayHelperCXType_OCLImage2dDepthRW = 150;
  static const int ArrayHelperCXType_OCLImage2dArrayDepthRW = 151;
  static const int ArrayHelperCXType_OCLImage2dMSAARW = 152;
  static const int ArrayHelperCXType_OCLImage2dArrayMSAARW = 153;
  static const int ArrayHelperCXType_OCLImage2dMSAADepthRW = 154;
  static const int ArrayHelperCXType_OCLImage2dArrayMSAADepthRW = 155;
  static const int ArrayHelperCXType_OCLImage3dRW = 156;
  static const int ArrayHelperCXType_OCLSampler = 157;
  static const int ArrayHelperCXType_OCLEvent = 158;
  static const int ArrayHelperCXType_OCLQueue = 159;
  static const int ArrayHelperCXType_OCLReserveID = 160;
  static const int ArrayHelperCXType_ObjCObject = 161;
  static const int ArrayHelperCXType_ObjCTypeParam = 162;
  static const int ArrayHelperCXType_Attributed = 163;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCMcePayload = 164;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCImePayload = 165;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCRefPayload = 166;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCSicPayload = 167;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCMceResult = 168;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCImeResult = 169;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCRefResult = 170;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCSicResult = 171;
  static const int
      ArrayHelperCXType_OCLIntelSubgroupAVCImeResultSingleRefStreamout = 172;
  static const int
      ArrayHelperCXType_OCLIntelSubgroupAVCImeResultDualRefStreamout = 173;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCImeSingleRefStreamin =
      174;
  static const int ArrayHelperCXType_OCLIntelSubgroupAVCImeDualRefStreamin =
      175;
  static const int ArrayHelperCXType_ExtVector = 176;
}
