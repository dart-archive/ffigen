...
class NSObject extends _ObjCWrapper {
  ...
  static bool conformsToProtocol_(
      CastTestObjCLibrary _lib, NSObject? protocol) {
  ...
  static bool isSubclassOfClass_(CastTestObjCLibrary _lib, NSObject aClass) {
  ...
  static void setVersion_(CastTestObjCLibrary _lib, int aVersion) {
  ...
  static void poseAsClass_(CastTestObjCLibrary _lib, NSObject aClass) {
    _lib._objc_msgSend_8(
