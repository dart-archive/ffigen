...
class init_dylib1 {
  ...
  init_dylib1(this._wasmInstance);
  ...
  late final void Function() _test = lookup('test');
...
''';
  ...
  static init_dylib1? _instance;
  static init_dylib1 get instance {
    assert(_instance != null,
        "need to init_dylib1.init() before accessing instance");
    return _instance!;
  }

  static Future<init_dylib1> init(dart_typed.Uint8List moduleData) async {
    final wasm_interop.Instance instance =
        await wasm_interop.Instance.fromBytesAsync(moduleData);
    _instance = init_dylib1(instance);
    return init_dylib1.instance;
  }
}

class ArrayHelperPrefixCollisionTest extends Opaque {
  ArrayHelperPrefixCollisionTest(int address) : super(address);
}
...
String toDartString(Pointer<Int8> ptr) {
  return _decodeUtf8ListString(init_dylib1.instance.memView, ptr.address);
}
