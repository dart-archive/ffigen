...
class BlockTester extends NSObject {
  ...
  int call(int x) {
    return _lib._objc_msgSend_17(_id, _lib._sel_call_1, x);
  }

  IntBlock getBlock() {
    return _lib._objc_msgSend_18(_id, _lib._sel_getBlock1);
  }
...
class NSObject extends _ObjCWrapper {
  ...
  static bool conformsToProtocol(BlockTestObjCLibrary _lib, NSObject protocol) {
