...
class Struct1 extends Opaque {
  Struct1(int address) : super(address);
}

class Union1 extends Opaque {
  Union1(int address) : super(address);
}

class EmptyUnion extends Opaque {
  EmptyUnion(int address) : super(address);
}

class Primitives extends Opaque {
  Primitives(int address) : super(address);
}

class PrimitivesWithPointers extends Opaque {
  PrimitivesWithPointers(int address) : super(address);
}

class WithArray extends Opaque {
  WithArray(int address) : super(address);
}
