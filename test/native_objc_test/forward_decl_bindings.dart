...
class NSObject extends _ObjCWrapper {
  ...
  static void setVersion_(ForwardDeclTestObjCLibrary _lib, int aVersion) {
  ...
  static void poseAsClass_(ForwardDeclTestObjCLibrary _lib, NSObject aClass) {
    _lib._objc_msgSend_8(
...
class NSString extends _ObjCWrapper {
  ...
  static NSString stringWithCString_encoding_(ForwardDeclTestObjCLibrary _lib,
