...
import 'package:shared_bindings/generated/base_gen.dart' as import1;
...
class NativeLibraryASharedB {
  ...
  void a_func2(
    import1.BaseStruct2 s,
    import1.BaseUnion2 u,
    import1.BaseTypedef2 t,
  ) {
    return _a_func2(
      s,
      u,
  ...
  late final _a_func2Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(import1.BaseStruct2, import1.BaseUnion2,
              import1.BaseTypedef2)>>('a_func2');
  late final _a_func2 = _a_func2Ptr.asFunction<
      void Function(
          import1.BaseStruct2, import1.BaseUnion2, import1.BaseTypedef2)>();
}
